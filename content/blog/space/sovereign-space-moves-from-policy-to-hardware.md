---
title: "Sovereign Space Capability Is Starting to Look Like Signed Contracts and Flown Hardware"
seoTitle: "IRIS² and Lunar Laser Links: Sovereign Space Gets Real"
description: "OHB's nearly €1 billion IRIS² contract and China's Earth-Moon laser link show strategic autonomy in space shifting from policy to funded, operating hardware."
date: 2026-09-01T09:05:00+08:00
draft: false
author: "Clement Chen"
categories: ["space"]
tags: ["IRIS2", "sovereign space infrastructure", "optical communications", "MEO satellites", "space policy"]
toc: true
related_posts: ["/blog/space/in-orbit-demonstration-is-still-the-bottleneck", "/blog/space/orbit-is-getting-more-crowded-and-more-volatile"]
---

Two stories landed within days of each other this week, and neither one is a strategy paper. OHB signed a contract worth nearly €1 billion with SES to build 18 medium-Earth-orbit (MEO) satellite platforms under Europe's IRIS² secure-connectivity programme ([details via SpaceWatch](https://spacewatch.global/2026/09/ohb-signs-first-major-industrial-contract-worth-nearly-e1-billion-under-europes-iris%c2%b2-program/)), and China demonstrated a two-way, high-speed laser communications link stretching more than 400,000 kilometres between Earth and the Moon ([as SpaceWatch reported](https://spacewatch.global/2026/08/china-demonstrates-earth-moon-laser-communication-link-as-lunar-ambitions-expand/)). Different continents, different technologies, same underlying signal: "strategic autonomy" is no longer a phrase that lives in government white papers. It's a line item, a delivery schedule, and, in one case, a beam of light that actually made the round trip.

<!--more-->

## From concession framework to purchase order

IRIS² has existed as a concept for a while: Europe's own secure-connectivity architecture, built so the continent isn't dependent on infrastructure it doesn't control. What changed this week is that the concept acquired a supplier. OHB's contract with SES covers the development and production of 18 MEO satellite platforms, and it's described as the first major industrial contract signed under the IRIS² concession ([SpaceWatch's report on the deal](https://spacewatch.global/2026/09/ohb-signs-first-major-industrial-contract-worth-nearly-e1-billion-under-europes-iris%c2%b2-program/)).
